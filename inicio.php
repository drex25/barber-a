...
<body class="conferencia">
        ...
        <div class="hero">
            <div class="contenido-header">
                ...
                <div class="informacion-evento">
                    <div class="clearfix">
                        <p class="fecha"><i class="fa fa-calendar" aria-hidden="true"></i> 16-04 Avr</p>
                        <p class="ciudad"><i class="fa fa-map-marker" aria-hidden="true"></i> Posadas, ARG</p>
                    </div>

                    <h1 class="nombre-sitio">Barbershop</h1>
                    <p class="slogan">La mejor salón de belleza <span>en misiones, Argentina</span></p>
                </div>
                <!--.informacion-evento-->
    ...
    <section class="seccion contenedor">
        <h2>La mejor salón de belleza en misiones, Argentina</h2>
        <p>
